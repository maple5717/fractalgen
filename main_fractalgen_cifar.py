...
def main(args):
    ...
    if not args.evaluate_gen:
        dataset_train = datasets.CIFAR10(root='../cifar10', train=True, download=True, transform=transform_train)
        dataset_val = datasets.CIFAR10(root='./cifar10', train=False, download=True, transform=transform_val)
